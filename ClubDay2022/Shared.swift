...
enum Shared {
    ...
    static let emotes: [Emote] = [
        .init(name: "10th_Anniversary_Supercel_King", audioFileName: "Goblin White Flag Emote"),
        .init(name: "Angry_King", audioFileName: "All Clash Royale Emotes"),
        .init(name: "Angry_Princess", audioFileName: "Angry Barbarian Emote"),
        .init(name: "Arrow_Dark_Prince", audioFileName: "Angry Giant Emote"),
        .init(name: "Baby_Dragon_Kissing", audioFileName: "Angry Goblin Emote"),
        .init(name: "Baby_Dragon_Licking", audioFileName: "Angry King Emote"),
        .init(name: "Blink_Inferno_Tower", audioFileName: "Angry Princess Emote"),
        .init(name: "Bored_Valkyrie", audioFileName: "Angry Ram Rider Emote"),
        ...
        .init(name: "Dance_Mini_PEKKA", audioFileName: "Dark Prince Arrow Emote"),
        ...
        .init(name: "Flame_Wizard", audioFileName: "Goblin Bicep Emote"),
        ...
        .init(name: "Hammer_Hog", audioFileName: "Goblin Kissing Emote"),
        ...
        .init(name: "Yawn_Princess", audioFileName: "Sleeping Pig Emote"),
        ...
        .init(name: "Baby_Dragon_Kissing", audioFileName: "Wizard IDK Emote"),
        .init(name: "Baby_Dragon_Licking", audioFileName: "Yawning Princess Emote"),
    ]
}
